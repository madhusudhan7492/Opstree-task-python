...
for instance in Instance_Id:
    ...
    for state in response['StoppingInstances']:
        ...
        t.add_rows([['Name','Instance_Id', 'Instance_Type','Instance_State'], [Instance_Name,instance ,describe_instance_['Reservations'][0]['Instances'][0]['InstanceType'],current_state_0]])
        print(t.draw())
        while current_state_0 == "stopping" or current_state_0 == "stopped":
            ...
            if (modify_instance['ResponseMetadata']['HTTPStatusCode'] == 200):
                ...
                t.add_rows([['Name','Instance_Id', 'Instance_Type','Instance_State'], [Instance_Name,instance ,describe_instance_1['Reservations'][0]['Instances'][0]['InstanceType'],current_state_1]])
                print(t.draw())
                print("*"*60)
